...
//            BufferedReader br = new BufferedReader(fis);
            ...
            InputStreamReader fis = new InputStreamReader(new FileInputStream("D:\\zhiban.html"), "UTF-8");
            BufferedReader br = new BufferedReader(fis);
            ...
            fis.close();// 关闭输入流
            // 从构建器中生成字符串，并替换搜索文本
            String str = sb.toString().replace("${th}", new String("只是一个入侵文件".getBytes("UTF-8"), "UTF-8"));
